...
tf.app.flags.DEFINE_string('stu_model_dir', '/docker_data/ModelCompression/model/student_nips/model.ckpt', 'Directory where checkpoints and event logs are written to.')
