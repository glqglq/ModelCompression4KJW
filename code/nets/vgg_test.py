...
class VGGATest(tf.test.TestCase):
  ...
  def testBuild(self):
    ...
    with self.test_session():
      ...
      logits, _ = vgg_conv_yk.vgg_a(inputs, num_classes)
  ...
  def testFullyConvolutional(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_a(inputs, num_classes, spatial_squeeze=False)
  ...
  def testEndPoints(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      _, end_points = vgg_conv_yk.vgg_a(inputs, num_classes)
  ...
  def testNoClasses(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      net, end_points = vgg_conv_yk.vgg_a(inputs, num_classes)
      expected_names = ['vgg_a/conv1/conv1_1',
                        'vgg_a/pool1',
                        'vgg_a/conv2/conv2_1',
                        'vgg_a/pool2',
  ...
  def testModelVariables(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      vgg_conv_yk.vgg_a(inputs, num_classes)
  ...
  def testEvaluation(self):
    ...
    with self.test_session():
      ...
      logits, _ = vgg_conv_yk.vgg_a(eval_inputs, is_training=False)
      self.assertListEqual(logits.get_shape().as_list(),
                           [batch_size, num_classes])
  ...
  def testTrainEvalWithReuse(self):
    ...
    with self.test_session():
      ...
      logits, _ = vgg_conv_yk.vgg_a(train_inputs)
      self.assertListEqual(logits.get_shape().as_list(),
  ...
  def testForward(self):
    ...
    with self.test_session() as sess:
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_a(inputs)
...
class VGG16Test(tf.test.TestCase):
  ...
  def testBuild(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_16(inputs, num_classes)
  ...
  def testFullyConvolutional(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_16(inputs, num_classes, spatial_squeeze=False)
  ...
  def testEndPoints(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      _, end_points = vgg_conv_yk.vgg_16(inputs, num_classes)
  ...
  def testNoClasses(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      net, end_points = vgg_conv_yk.vgg_16(inputs, num_classes)
      expected_names = ['vgg_16/conv1/conv1_1',
                        'vgg_16/conv1/conv1_2',
                        'vgg_16/pool1',
                        'vgg_16/conv2/conv2_1',
  ...
  def testModelVariables(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      vgg_conv_yk.vgg_16(inputs, num_classes)
  ...
  def testEvaluation(self):
    ...
    with self.test_session():
      eval_inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_16(eval_inputs, is_training=False)
      self.assertListEqual(logits.get_shape().as_list(),
                           [batch_size, num_classes])
      predictions = tf.argmax(logits, 1)
      self.assertListEqual(predictions.get_shape().as_list(), [batch_size])
  ...
  def testTrainEvalWithReuse(self):
    ...
    with self.test_session():
      train_inputs = tf.random_uniform(
          (train_batch_size, train_height, train_width, 3))
      logits, _ = vgg_conv_yk.vgg_16(train_inputs)
      self.assertListEqual(logits.get_shape().as_list(),
                           [train_batch_size, num_classes])
      tf.get_variable_scope().reuse_variables()
      eval_inputs = tf.random_uniform(
  ...
  def testForward(self):
    ...
    with self.test_session() as sess:
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_16(inputs)
      sess.run(tf.global_variables_initializer())
      output = sess.run(logits)
      self.assertTrue(output.any())
...
class VGG19Test(tf.test.TestCase):
  ...
  def testBuild(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_19(inputs, num_classes)
  ...
  def testFullyConvolutional(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_19(inputs, num_classes, spatial_squeeze=False)
  ...
  def testEndPoints(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      _, end_points = vgg_conv_yk.vgg_19(inputs, num_classes)
      expected_names = [
  ...
  def testNoClasses(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      net, end_points = vgg_conv_yk.vgg_19(inputs, num_classes)
      expected_names = [
          'vgg_19/conv1/conv1_1',
          'vgg_19/conv1/conv1_2',
          'vgg_19/pool1',
  ...
  def testModelVariables(self):
    ...
    with self.test_session():
      inputs = tf.random_uniform((batch_size, height, width, 3))
      vgg_conv_yk.vgg_19(inputs, num_classes)
      expected_names = [
  ...
  def testEvaluation(self):
    ...
    with self.test_session():
      eval_inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_19(eval_inputs, is_training=False)
      self.assertListEqual(logits.get_shape().as_list(),
                           [batch_size, num_classes])
      predictions = tf.argmax(logits, 1)
      self.assertListEqual(predictions.get_shape().as_list(), [batch_size])
  ...
  def testTrainEvalWithReuse(self):
    ...
    with self.test_session():
      train_inputs = tf.random_uniform(
          (train_batch_size, train_height, train_width, 3))
      logits, _ = vgg_conv_yk.vgg_19(train_inputs)
      self.assertListEqual(logits.get_shape().as_list(),
                           [train_batch_size, num_classes])
      tf.get_variable_scope().reuse_variables()
      eval_inputs = tf.random_uniform(
  ...
  def testForward(self):
    ...
    with self.test_session() as sess:
      inputs = tf.random_uniform((batch_size, height, width, 3))
      logits, _ = vgg_conv_yk.vgg_19(inputs)
      sess.run(tf.global_variables_initializer())
      output = sess.run(logits)
      self.assertTrue(output.any())
