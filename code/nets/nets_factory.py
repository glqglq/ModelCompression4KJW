...
networks_map = {'alexnet_v2': alexnet.alexnet_v2,
                ...
                'vgg_a': vgg_conv_yk.vgg_a,
                'vgg_16': vgg_conv_yk.vgg_16,
                'vgg_19': vgg_conv_yk.vgg_19,
                'vgg_16_stu':vgg_stu_1.vgg_16,
...
arg_scopes_map = {'alexnet_v2': alexnet.alexnet_v2_arg_scope,
                  ...
                  'vgg_a': vgg_conv_yk.vgg_arg_scope,
                  'vgg_16': vgg_conv_yk.vgg_arg_scope,
                  'vgg_16_stu':vgg_stu_1.vgg_arg_scope,
                  'vgg_19': vgg_conv_yk.vgg_arg_scope,
...
def get_network_fn(name, num_classes, weight_decay=0.9, is_training=False):
  ...
  Returns:
    network_fn: A function that applies the model to a batch of images. It has
      ...
      The returned `end_points` are a dictionary of intermediate activations.  返回的`end_points`是中间激活的字典。
