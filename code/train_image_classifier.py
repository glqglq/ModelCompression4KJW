...
tf.app.flags.DEFINE_string(
    'train_dir', '/docker_data/out/teacher/out',
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/docker_data/out/teacher/pre_pam/vgg_16.ckpt',
...
def _get_init_fn():
  ...
  #     global a
  #     a=''
  #     print(var.op.name,'vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv')
  #
  #     if var.op.name == 'vgg_16/conv1/conv1_1/weights':
  #         a = 'conv1_1/weights';
  #
  #     if var.op.name == 'vgg_16/conv1/conv1_2/weights':
  #         a = 'conv1_2/weights';
  #     if var.op.name == 'vgg_16/conv2/conv2_1/weights':
  #         a = 'conv2_1/weights';
  #     if var.op.name == 'vgg_16/conv2/conv2_2/weights':
  #         a = 'conv2_2/weights';
  #     if var.op.name == 'vgg_16/conv3/conv3_1/weights':
  #         a = 'conv3_1/weights';
  #     if var.op.name == 'vgg_16/conv3/conv3_2/weights':
  #         a = 'conv3_2/weights';
  #     if var.op.name == 'vgg_16/conv3/conv3_3/weights':
  #         a = 'conv3_3/weights';
  #     if var.op.name == 'vgg_16/conv4/conv4_1/weights':
  #         a = 'conv4_1/weights';
  #     if var.op.name == 'vgg_16/conv4/conv4_2/weights':
  #         a = 'conv4_2/weights';
  #     if var.op.name == 'vgg_16/conv4/conv4_3/weights':
  #         a = 'conv4_3/weights';
  #     if var.op.name == 'vgg_16/conv5/conv5_1/weights':
  #         a = 'conv5_1/weights';
  #     if var.op.name == 'vgg_16/conv5/conv5_2/weights':
  #         a = 'conv5_2/weights';
  #     if var.op.name == 'vgg_16/conv5/conv5_3/weights':
  #         a = 'conv5_3/weights';
  #     if var.op.name == 'vgg_16/fc6/weights':
  #         a = 'fc6/weights';
  #     if var.op.name == 'vgg_16/fc7/weights':
  #         a = 'fc7/weights';
  #     if var.op.name == 'vgg_16/fc8/weights':
  #         a = 'fc8/weights';
  #
  #
  #     if var.op.name == 'vgg_16/conv1/conv1_1/biases':
  #         a = 'conv1_1/biases';
  #     if var.op.name == 'vgg_16/conv1/conv1_2/biases':
  #         a = 'conv1_2/biases';
  #     if var.op.name == 'vgg_16/conv2/conv2_1/biases':
  #         a = 'conv2_1/biases';
  #
  #     if var.op.name == 'vgg_16/conv2/conv2_2/biases':
  #         a = 'conv2_2/biases';
  #
  #     if var.op.name == 'vgg_16/conv3/conv3_1/biases':
  #         a = 'conv3_1/biases';
  #
  #     if var.op.name == 'vgg_16/conv3/conv3_2/biases':
  #         a = 'conv3_2/biases';
  #     if var.op.name == 'vgg_16/conv3/conv3_3/biases':
  #         a = 'conv3_3/biases';
  #     if var.op.name == 'vgg_16/conv4/conv4_1/biases':
  #         a = 'conv4_1/biases';
  #     if var.op.name == 'vgg_16/conv4/conv4_2/biases':
  #         a = 'conv4_2/biases';
  #     if var.op.name == 'vgg_16/conv4/conv4_3/biases':
  #         a = 'conv4_3/biases';
  #     if var.op.name == 'vgg_16/conv5/conv5_1/biases':
  #         a = 'conv5_1/biases';
  #     if var.op.name == 'vgg_16/conv5/conv5_2/biases':
  #         a = 'conv5_2/biases';
  #     if var.op.name == 'vgg_16/conv5/conv5_3/biases':
  #         a = 'conv5_3/biases';
  #     if var.op.name == 'vgg_16/fc6/biases':
  #         a = 'fc6/biases';
  #     if var.op.name == 'vgg_16/fc7/biases':
  #         a = 'fc7/biases';
  #     if var.op.name == 'vgg_16/fc8/biases':
  #         a = 'fc8/biases';
  #
  ...
  #     restorer.restore(sess, "/code/slim/param/checkpoint")
